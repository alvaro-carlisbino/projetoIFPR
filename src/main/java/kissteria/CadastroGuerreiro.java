...
public class CadastroGuerreiro extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        txtNome.getText(),
        Integer.parseInt(txtPontosVida.getText()),
        Integer.parseInt(txtPontosAtaque.getText()),
        Integer.parseInt(txtPontosDefesa.getText()),
        "TipoDePersonagem",  // criar ainda o tipo de guerreiro 
        Integer.parseInt(txtForca.getText()),
        Integer.parseInt(txtVelocidade.getText())
    );
